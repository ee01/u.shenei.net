...
.fLGn .cb{background-color:limegreen}
...
a.icoMusic {background-position:-610px 1px}
...
<a href="javascript:;" class="icoMusic" id="icoMusic" onClick="createMusic(event, 0);return false;" title="插入音乐"></a>
...
<a href="javascript:void(0)" onClick="format(gSetColorType,'orangered')" class="n cs fORd"><b class="cb"></b><span>橘红色</span></a>
...
<a href="javascript:void(0)" onClick="format(gSetColorType,'mediumpurple')" class="n cs fMPp"><b class="cb"></b><span>中紫色</span></a>
...
<a href="javascript:void(0)" onClick="format(gSetColorType,'limegreen')" class="n cs fLGn"><b class="cb"></b><span>橙绿色</span></a>
...
<div id="editFaceBox" class="eMenu" style="display:none;top:35px;left:26px;width:250px;"></div>
...
<div id="createMusic" class="eMenu" style="display:none;top:35px;left:26px;width:400px;font-size:12px">
	...
	<input type="button" onClick="createMusic();" name="createURL" value="确定" class="submit" />
