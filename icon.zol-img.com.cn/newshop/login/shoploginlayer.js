    ...
    */
    ...
    var locationUrl = {
        'shop' : {'name':'\u005a\u004f\u004c\u5546\u57ce','url':'../www.zol.com','regUrl':'../https@login.zol.com/index.php@c=Default&a=Register'}, //商城
        'dealer':{'name':'\u005a\u004f\u004c\u7ecf\u9500\u5546','url':'./','regUrl':'register.html'}, //经销商
        'qyg':{'name':'\u005a\u004f\u004c\u4f01\u4e1a\u8d2d','url':'qyg/default.htm','regUrl':'../q.zol.com.cn/index.php@c=UserRegister'} //企业购
    };
    ...
    ZsLogin.openLoginBox = function (){
        ...
        var boxStr  = '';
            ...
            boxStr += '<a target="_blank" href="../my.zol.com.cn/index.php@c=getPassword">忘记密码？</a>';
            boxStr += '</div>';
            ...
            if(loginParams.showType != 'qyg'){
                boxStr += '<div class="login-foot clearfix"><span>合作账号登录：</span><a target="_blank" class="sina" href="../service.zol.com.cn/user/api/sina/jump.php@comeshop=1&backurl=' + backUrl + '">用微博账号登录</a><a target="_blank" class="qq" href="../service.zol.com.cn/user/api/qq/libs/oauth/redirect_to_login.php@comeshop=1&backurl=' + backUrl + '">用QQ账号登录</a><a target="_blank" class="alipay" href="../tuan.zol.com/userBinding/alipay/alipay.auth.authorize_php_gb/alipay_auth_authorize.php@fromUrl='+backUrl+'">用支付宝账号登录</a><a target="_blank" class="baidu" href="../service.zol.com.cn/user/api/baidu/jump.php@comeshop=1&backurl='+backUrl+'">用百度账号</a></div>';
            }
...
//            });
    ...
    ZsLogin.userPhoneLoginCallback = function (jsonData){
        var jsonData = jsonData;
        if (jsonData.flag){
            var url = "../m.zol.com.cn/user/api/phoneLogin.php@token="+jsonData.token + "&phone=" + jsonData.mobile + "&t=" + jsonData.time;
