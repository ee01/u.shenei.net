...
$acs = array(
	array('index','config', 'privacy', 'ip', 'spam', 'hotuser', 'defaultuser', 'usergroup', 'credit', 'card', 'exchangeclass', 'magic', 'magiclog', 'profield', 'ad', 'tuishare', 'attention', 'userapp'),	//Modify By 01
	...
	array('ND_config','type','list','ND_comment','ND_report')
);
