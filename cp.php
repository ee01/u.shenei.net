...
$acs = array('space', 'doing', 'upload', 'comment', 'blog', 'album', 'relatekw', 'common', 'class',
	...
	'userapp', 'task', 'credit', 'card', 'password', 'domain', 'event', 'poll', 'topic',
	'click','magic', 'top', 'videophoto', 'subject', 'fetion', 'sign', 'uploadbg', 'blogtitle', 'polltitle', 'prolifetitle', 'friendtitle', 'hometitle', 'albumtitle', 'walltitle', 'aboutmetitle', 'applisttitle');	//Modify By 01
