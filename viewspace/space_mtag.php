...
/*
	...
	$Id: space_mtag.php 10314 2008-11-28 09:09:23Z liguode $
*/
...
if($id) {
	...
	//最新话题
	$threadlist = array();
	$query = $_SGLOBAL['db']->query("SELECT main.*,field.tagname,field.membernum,field.fieldid FROM ".tname('thread')." main FORCE INDEX(lastpost)
		LEFT JOIN ".tname('mtag')." field ON field.tagid=main.tagid
