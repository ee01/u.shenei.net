...
function doplaymusic(ctype,objname,music,cid){
		...
		if(ctype==1){
			el(objname).innerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,124,0" width="100%" height="24" id="cmp"><param name="movie" value="cmp.swf?src='+music+'&skin_src=mini/mini02.zip&auto_play=1&play_mode=1&context_menu=0&show_tip=0&plugins_disabled=1&c.swf" /><param name="quality" value="high" /><param name="allowFullScreen" value="true" /><param name="allowScriptAccess" value="always" /><param name="wmode" value="Transparent"/><embed pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100%" height="24" name="cmp" src="cmp.swf?src='+music+'&skin_src=mini/mini02.zip&auto_play=1&play_mode=1&context_menu=0&show_tip=0&plugins_disabled=1&c.swf" quality="high"  allowfullscreen="true" allowscriptaccess="always" wmode="Transparent" ></embed></object>';
		}else{
			el(objname).innerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,124,0" width="100%" height="24" id="cmp"><param name="movie" value="cmp.swf?src='+music+'&skin_src=mini/mini02.zip&auto_play=1&play_mode=1&context_menu=0&show_tip=0&plugins_disabled=1&c.swf" /><param name="quality" value="high" /><param name="allowFullScreen" value="true" /><param name="allowScriptAccess" value="always" /><param name="wmode" value="Transparent"/><embed pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100%" height="24" name="cmp" src="cmp.swf?src='+music+'&skin_src=mini/mini02.zip&auto_play=1&play_mode=1&context_menu=0&show_tip=0&plugins_disabled=1&c.swf" quality="high"  allowfullscreen="true" allowscriptaccess="always" wmode="Transparent" ></embed></object>';
		}
}
...
function doplaymusicwin(ctype,objname,music,cid){
		...
		el(objname).style.display = '';
		if(ctype==1){
			document.getElementById(objname).innerHTML = '<object id="Player" width="100%" height="62" classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6" codebase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,4,7,1112" align="baseline" border="0" standby="Loading Microsoft Windows Media Player components..." type="application/x-oleobject"><param name="URL" value="'+music+'"><param name="autoStart" value="true"><param name="invokeURLs" value="false"><param name="playCount" value="100"><param name="volume" value="80"><param name="enableContextMenu" value="1"><param name="defaultFrame" value="datawindow"><embed name="player" type="application/x-mplayer2" height="62" width="100%" showstatusbar="true" autostart="true" pluginspage="http://www.microsoft.com/windows/windowsmedia/" src="'+music+'"></object>';
		}else{
			document.getElementById(objname).innerHTML = '<object id="Player" width="100%" height="62" classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6" codebase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,4,7,1112" align="baseline" border="0" standby="Loading Microsoft Windows Media Player components..." type="application/x-oleobject"><param name="URL" value="'+music+'"><param name="autoStart" value="true"><param name="invokeURLs" value="false"><param name="playCount" value="100"><param name="volume" value="80"><param name="enableContextMenu" value="1"><param name="defaultFrame" value="datawindow"><embed name="player" type="application/x-mplayer2" height="62" width="100%" showstatusbar="true" autostart="true" pluginspage="http://www.microsoft.com/windows/windowsmedia/" src="'+music+'"></object>';
		}
}
